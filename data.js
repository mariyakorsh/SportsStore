module.exports = function () {
  return {
    products: [
      ...
      {id: 2, name: "Lifejacket", category: "Watersports", description: "Protectiv and fashionable", price: 48.95},
      ...
      {id: 7, name: "Unsteady Chair", category: "Chess", description: "Secretly give your opponent a disadvavtage", price: 29.95},
